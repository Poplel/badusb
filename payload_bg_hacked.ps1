...
# echo "Hey" $fn >> $Env:temp\foo.txt  # Removed this line

# echo "`nYour computer is not very secure" >> $Env:temp\foo.txt # Removed this line
...
$GL = Get-GeoLocation
# if ($GL) { echo "`nYour Location: `n$GL" >> $Env:temp\foo.txt } # Removed this line
...
$PubIP = Get-PubIP
# if ($PubIP) { echo "`nYour Public IP: $PubIP" >> $Env:temp\foo.txt } # Removed this line
...
$pls = Get-Days_Set
# if ($pls) { echo "`nPassword Last Set: $pls" >> $Env:temp\foo.txt } # Removed this line
...
Foreach($WLANProfileName in $WLANProfileNames){
    ...
    #echo "`nW-Lan profiles: ===============================" $WLANProfileObjects >> $Env:temp\foo.txt #Removed this line

#$content = [IO.File]::ReadAllText("$Env:temp\foo.txt") #Removed this line
    #}
#############################################################################################################################################
